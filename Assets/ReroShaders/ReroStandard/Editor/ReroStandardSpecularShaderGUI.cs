...
{
    internal class ReroStandardSpecularShaderGUI : ShaderGUI
    {
        ...
        void DoAlbedoArea(Material material)
        {
			...
			if (stylizeSpec.floatValue == 1)
			{
				...
				m_MaterialEditor.ShaderProperty(rampHard, Styles.rampHardText);
			}
        ...
        public static void SetupMaterialWithBlendMode(Material material, BlendMode blendMode)
        {
            switch (blendMode)
            {
                case BlendMode.Opaque:
                    //material.shader=Shader.Find("Hidden/.Rero/Rero Standard/Rero Standard (Specular Setup) Opaque");
                ...
                case BlendMode.Cutout:
                    //material.shader=Shader.Find("Hidden/.Rero/Rero Standard/Rero Standard (Specular Setup) Cutout");
                    material.SetInt("_SrcBlend", (int)UnityEngine.Rendering.BlendMode.One);
                    material.SetInt("_DstBlend", (int)UnityEngine.Rendering.BlendMode.Zero);
                    material.SetInt("_ZWrite", 1);
                    ...
                    break;
                case BlendMode.Fade:
                    //material.shader=Shader.Find("Hidden/.Rero/Rero Standard/Rero Standard (Specular Setup) Fade");
                ...
                case BlendMode.Transparent:
                    //material.shader=Shader.Find("Hidden/.Rero/Rero Standard/Rero Standard (Specular Setup) Transparent");
                    material.SetInt("_SrcBlend", (int)UnityEngine.Rendering.BlendMode.One);
                    material.SetInt("_DstBlend", (int)UnityEngine.Rendering.BlendMode.OneMinusSrcAlpha);
                    material.SetInt("_ZWrite", 0);
                    material.DisableKeyword("_ALPHATEST_ON");
